...
//        Mentor mentor19 = new Mentor("이수민", "사회복지학", Arrays.asList("사회복지실천", "사회복지정책", "사회복지행정", "복지법", "사회복지윤리"));
...
//        Mentee mentee1 = new Mentee("유민석", Arrays.asList("사회복지학", "노인", "아동", "봉사", "요양원"), Arrays.asList("복지","정책"), false);
